...
#### It acts a linear and nonlinear classifier depending upon the number of neuron layers in the network.
...
#### Ya this network can be trained to follow another object, but for that you will just need produce proper data set. The data provided for the project can't used for following another object.
#### In case of developing  an architecture for classfifying dog and car you may need extra layer of encoders and decoders. This is because on surface level dog and cat are much alike. You need extra layers for delailed classification.
---
# Output 
## Training loss graph
![alt text][image2]
